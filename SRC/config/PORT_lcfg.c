...
const PORT_PinType PORT_PinGroup[PORT_ACTIVATED_PINS_NUMBER] =
{
		...
		{Port_Channel_B4, Dir_Input, Mode_Dio_With_Pullup_Res },
		{Port_Channel_B5, Dir_Input, Mode_Dio_With_Pullup_Res },
		{Port_Channel_B6, Dir_Input, Mode_Dio_With_Pullup_Res },
		{Port_Channel_B7, Dir_Input, Mode_Dio_With_Pullup_Res },
		/* Group C */
		...
		{Port_Channel_D3, Dir_Output, Mode_Dio },
		{Port_Channel_D4, Dir_Output, Mode_Dio },
