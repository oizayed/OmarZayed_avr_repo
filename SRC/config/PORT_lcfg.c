...
const PORT_PinType PORT_PinGroup[PORT_ACTIVATED_PINS_NUMBER] =
{
		...
		/*             Group B                        */
		{Port_Channel_B0, Dir_Output, Mode_Dio },
		{Port_Channel_B1, Dir_Output, Mode_Dio },
		{Port_Channel_B2, Dir_Output, Mode_Dio },
		{Port_Channel_B3, Dir_Output, Mode_Dio },
		{Port_Channel_B4, Dir_Output, Mode_Dio },
		{Port_Channel_B5, Dir_Output, Mode_Dio },
		{Port_Channel_B6, Dir_Output, Mode_Dio },
		{Port_Channel_B7, Dir_Output, Mode_Dio },
		/* Group C */
